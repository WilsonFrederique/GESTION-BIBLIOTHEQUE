        ...
        <section id="content">
            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        <h1>LISTE DES ÉLÉMENTS À RENDRE</h1>
                        <ul class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <a class="active" href="/GestionBibliotheque/Components/Rendres/indexRendres.jsp">Liste des retours</a>
                            </li>
                        </ul>
                    </div>
                    <a href="/GestionBibliotheque/Components/Rendres/FrmRendres.jsp" class="btn-download">
                        <i class='bx bx-plus' ></i>
                        <span class="text">AJOUT DE RENDUS</span>
                    </a>
                </div>
                ...
                <div class="table-date">
                    <div class="todo liste-des-retardataires" style="display: none;">
                        <div class="">
                            <div class="head">
                            ...
                            <ul class="todo-list todo-color">
                                <li class="not-completed">
                                    <div class="retardataire-info">
                                        <span class="nom">Nom et Prénom</span>
                                        <span class="date1">Date Prêt</span>
                                        <span class="date2">Date Retour</span>
                                        <span class="jours">Jours de retard</span>
                                    </div>
                                    <div class="retardataire-actions">
                                ...
                                <%
                                    try (
                                        ...
                                        PreparedStatement stmt = conn.prepareStatement(
                                            "SELECT p.idpret, p.idpers, m.nom, p.idlivre, p.datepret, p.dateretour " +
                                            "FROM preter p " +
                                            "JOIN membre m ON p.idpers = m.idpers " +
                                            "WHERE p.dateretour < ? " +
                                            "AND NOT EXISTS (" +
                                                "SELECT 1 FROM rendre r " +
                                                "WHERE r.idpers = p.idpers AND r.idlivre = p.idlivre" +
                                            ")"
                                        );
                                    ) {
                                        // Utiliser LocalDate pour les dates sans heure
                                        java.time.LocalDate aujourdhui = java.time.LocalDate.now();
                                        stmt.setDate(1, java.sql.Date.valueOf(aujourdhui));
                                        ...
                                        try (ResultSet rs = stmt.executeQuery()) {
                                            ...
                                            while (rs.next()) {
                                                ...
                                                String datepretFormatted = (datepretTimestamp != null)
                                                    ? displayFormat.format(datepretTimestamp)
                                                    : "N/A";

                                                String dateretourFormatted = (dateretourSql != null)
                                                    ? displayFormat.format(dateretourSql)
                                                    : "N/A";

                                                int joursRetard = 0;
                                                if (dateretourSql != null) {
                                                    java.time.LocalDate dateRetour = dateretourSql.toLocalDate();
                                                    joursRetard = (int) java.time.temporal.ChronoUnit.DAYS.between(dateRetour, aujourdhui);
                                                }
                                %>
                                <li class="not-completed">
                                    <div class="retardataire-info">
                                        <span class="nom"><%= nom %></span>
                                        <span class="date datePreter"><%= datepretFormatted %></span>
                                        <span class="date dateRetour"><%= dateretourFormatted %></span>
                                        <span class="date led-blink" style="color: #db504a; font-weight: bold;">
                                            <%= joursRetard %> jour(s) de retard
                                        </span>

                                        <!--Css Pour Ce Jours De Retard comme en Led-->
                                        <style>
                                            .led-blink {
                                                animation: ledBlink .2s infinite alternate;
                                              }
                                    ...
                                    <div class="retardataire-actions">
                                        <button type="submit" style="background: none; border: none; cursor: pointer;">
                                            <i class='bx bx-check' title="Marquer comme rendu"></i>
                                        </button>
                                    </div>
                                </li>
                                <%
                                ...
                                %>
                                <li class="not-completed">
                                    <div class="retardataire-info" style="justify-content: center;">
                                        <span style="text-align: center; font-style: italic; color: #666;">
                                            Aucun retardataire trouvé
                                        </span>
                                    </div>
                                </li>
                                <%
                                ...
                                <li class="not-completed">
                                    <div class="retardataire-info" style="justify-content: center;">
                                        <span style="text-align: center; color: #db504a;">
                                            Erreur lors du chargement des retardataires
                                        </span>
                                    </div>
                                </li>
                                <%
                ...
                <!--Liste de tous les éléments déjà rendus-->
                <div class="table-date">
                    <!--Order-->
                    <div class="orber">
                        <div class="head">
                            <h3>Derniers rendus</h3>
                            <div class="btn-pas-encore-rendus">
                                <button class="modern-btn" id="toggleRetardataires">
                                    <i class='bx bx-group'></i>
                                    <span>Retardataires</span>
                                </button>
                            </div>
                            <a href="/GestionBibliotheque/Components/Rendres/indexRendres.jsp">
                            ...
                            <tbody class="tbody">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String sql = "SELECT * FROM rendre";
                                        stmt = conn.prepareStatement(sql);
                                        rs = stmt.executeQuery();
                                        while (rs.next()) {
                                            String idrendu = rs.getString("idrendu");
                                            String idpers = rs.getString("idpers");
                                            String idlivre = rs.getString("idlivre");

                                            // Correction pour les dates
                                            java.sql.Timestamp daterenduTimestamp = rs.getTimestamp("daterendu");

                                            // Conversion en java.util.Date
                                            java.util.Date daterendu = null;

                                            if (daterenduTimestamp != null) {
                                                daterendu = new java.util.Date(daterenduTimestamp.getTime());
                                            }
                                            ...
                                            String daterenduFormatted = daterendu != null ? dateTimeFormat.format(daterendu) : "N/A";
                                            String daterenduShort = daterendu != null ? dateFormat.format(daterendu) : "N/A";
                                %>
                                
                                <tr>
                                    <td>
                                        <img src="/GestionBibliotheque/images/R.png" alt="Avatar">
                                        <p><%= idrendu %></p>
                                    </td>
                                    <td>
                                        <p><%= idpers %></p>
                                    ...
                                    <td><%= idlivre %></td>
                                    <td><span class="status completed"><%= daterenduShort %></span></td>
                                    <td class="action-icons">
                                        <a href="/GestionBibliotheque/Components/Rendres/FrmRendres.jsp?edit=true&idrendu=<%= idrendu %>&idpers=<%= idpers %>&idlivre=<%= idlivre %>&daterendu=<%= daterenduFormatted %>" 
                                           aria-label="Edit" title="Edit">
                                            <i class='bx bx-edit'></i>
                                        </a>
                                        <form method="get" action="<%= request.getContextPath() %>/ServletRendres" style="display:inline;">
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="/GestionBibliotheque/Components/Rendres/indexRendres.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
            </main>
            <!-- --------------------- Fin Main ----------------- -->
