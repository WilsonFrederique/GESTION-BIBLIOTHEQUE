    ...
    <body>        
        ...
        <section id="content">
            <%
                ...
                String idpers = "";
                String idlivre = "";
                String daterenduValue = "";

                if (isEditMode) {
                    idrendu = request.getParameter("idrendu") != null ? request.getParameter("idrendu") : "";
                    ...
                    // Gestion des dates
                    String daterenduParam = request.getParameter("daterendu");

                    if (daterenduParam != null && !daterenduParam.isEmpty()) {
                        try {
                            SimpleDateFormat inputFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm");
                            SimpleDateFormat outputFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm");
                            Date date = inputFormat.parse(daterenduParam);
                            daterenduValue = outputFormat.format(date);
                ...
                <div class="head-title">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a class="active" href="/GestionBibliotheque/Components/Rendres/indexRendres.jsp">Liste des rendus</a>
                            </li>
                            <% if (isEditMode) { %> 
                                <li><i class='bx bx-chevron-right'></i></li>
                                <li>
                            ...
                            <% } else { %>
                                <li><i class='bx bx-chevron-right'></i></li>
                                <li>
                                    <a class="active" href="#">Nouveau rendu</a>
                                </li>
                            <% } %>
                        </ul>
                    </div>
                ...
                <div class="todo">
                    <div class="container-frm-empl">
                        <div class="top-header">
                            <% if (isEditMode) { %>  
                                <header>MODIFICATION DE RENDU</header>
                            <% } else { %>
                                <header>NOUVEAU RENDU</header>
                            <% } %>
                            <img class="img" src="/GestionBibliotheque/images/R.png" alt="Avatar">
                        </div>
                        ...
                        <% if (error != null) { %>
                            <div class="alert-error" data-error="<%= error %>">
                                <% 
                                    ...
                                    switch(error) {
                                        case "id_existe_deja":
                                            errorMessage = "Cet ID de rendu existe déjà";
                                            break;
                                        case "champs_vides":
                                        ...
                                        case "connexion_bdd":
                                            ...
                                            break;
                                        case "rendu_non_trouve":
                                            errorMessage = "Rendu non trouvé";
                                            break;
                                        default:
                        ...
                        <form action="${pageContext.request.contextPath}/ServletRendres" method="POST">

                            <% if (isEditMode) { %>                                                
                                <input name="idrendu" value="<%= idrendu %>" type="hidden">
                            ...
                            <div class="form first">
                                <div class="details personal">
                                    <span class="title">Détails du rendu</span>

                                    <div class="fields">
                                        <% if (!isEditMode) { %>
                                            <div class="input-field-div">
                                                <label>ID RENDU *</label>                                                
                                                <input name="idrendu" type="text" placeholder="ID du rendu" required
                                                       value="<%= idrendu %>">
                                            </div>
                                        <% } %>
                                        ...
                                        <div class="input-field-div">
                                            ...
                                            <input name="daterendu" type="datetime-local" placeholder="Date du rendu" required
                                                   value="<%= daterenduValue %>">
                                        </div>
                                    </div>
