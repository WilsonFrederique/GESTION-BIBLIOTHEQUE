    ...
    <body>        
        ...
        <section id="content">
            <%
                ...
                String exemplaire = request.getParameter("exemplaire") != null ? request.getParameter("exemplaire") : "";
            ...
            <main>
                    ...
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <% } else { %>
                                <li><i class='bx bx-chevron-right' ></i></li>
                                <li>
                                    <a class="active" href="#">Ajout de livre</a>
                                </li>
                            <% } %>
                        </ul>
                    </div>
                ...
                <div class="todo">
                    <div class="container-frm-empl">
                        <div class="top-header">
                            ...
                            <% } else { %>
                                <header>Description du livre</header>
                            <% } %>
                            <img class="img" src="/GestionBibliotheque/images/L.png" alt="Avatar">
                        </div>

                        <form action="${pageContext.request.contextPath}/ServletLivres" method="POST">
                            <% if (isEditMode) { %>                                                
                                <input name="idlivre" value="<%= idlivre %>" type="hidden">
                                    ...
                                    <div class="fields">
                                        <% if (!isEditMode) { %>
                                            <div class="input-field-div">
                                                ...
                                                <input name="idlivre" type="text" placeholder="ID LIVRE" required>
                                            </div>
                                        <% } %>

                                        <div class="input-field-div">
                                            <label>DESIGNATION</label>
                                            <input name="designation" value="<%= designation %>" type="text" placeholder="DESIGNATION" required>
                                        </div>
                                        <div class="input-field-div">
                                            <label>EXEMPLAIRE</label>
                                            <input name="exemplaire" value="<%= exemplaire %>" type="number" placeholder="EXEMPLAIRE" min="1" required>
                                        </div>
                                    </div>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="/GestionBibliotheque/Components/Livres/FrmLivre.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
            </main>
        </section>
