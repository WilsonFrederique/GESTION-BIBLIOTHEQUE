            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a class="active" href="/GestionBibliotheque/Components/Livres/indexLivres.jsp">Liste des livres</a>
                            </li>
                        </ul>
                    </div>
                    <a href="/GestionBibliotheque/Components/Livres/FrmLivre.jsp" class="btn-download">
                        <i class='bx bx-plus' ></i>
                        <span class="text">AJOUT LIVRE</span>
                    </a>
                </div>
                            ...
                            <tbody class="tbody">
                                <%
                                    ...
                                    if (resultatsRecherche != null) {
                                        for (Map<String, String> livre : resultatsRecherche) {
                                %>
                                <tr>
                                    <td>
                                        <img src="/GestionBibliotheque/images/L.png" alt="Avatar">
                                        <p><%= livre.get("idlivre") %></p>
                                    </td>
                                    <td>
                                        <p><%= livre.get("designation") %></p>
                                    </td>
                                    <td><%= livre.get("exemplaire") %></td>
                                    <td class="action-icons">
                                        <a href="/GestionBibliotheque/Components/Livres/FrmLivre.jsp?edit=true&idlivre=<%= livre.get("idlivre") %>&designation=<%= livre.get("designation") %>&exemplaire=<%= livre.get("exemplaire") %>" 
                                           aria-label="Edit" title="Edit">
                                            <i class='bx bx-edit'></i>
                                        </a>
                                        <!-- Formulaire de suppression -->
                                        <form method="get" action="<%= request.getContextPath() %>/ServletLivres" style="display:inline;">
                                            <input type="hidden" name="action" value="delete">
                                            <input type="hidden" name="idlivre" value="<%= livre.get("idlivre") %>">
                                ...
                                <%
                                        ...
                                        // Code existant pour afficher tous les livres
                                ...
                                <tr>
                                    ...
                                    <td><%= exemplaire %></td>
                                    <td class="action-icons">
                                        <a href="/GestionBibliotheque/Components/Livres/FrmLivre.jsp?edit=true&idlivre=<%= idlivre %>&designation=<%= designation %>&exemplaire=<%= exemplaire %>" 
                                           aria-label="Edit" title="Edit">
                                            <i class='bx bx-edit'></i>
                                        </a>
                                        <!-- Formulaire de suppression -->
                ...
                <footer class="footer">
                    ...
                    <div class="footer-iconTop">
                        <a href="/GestionBibliotheque/Components/Livres/indexLivres.jsp"><i class='bx bx-up-arrow-alt'></i></a>
                    </div>
                </footer>
            </main>
            <!-- --------------------- Fin Main ----------------- -->
